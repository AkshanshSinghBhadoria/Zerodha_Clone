        ...
        <div className='container '>
            <div className='row p-5'>
                <div className='col-6 p-5'>
                    ...
                    <h2 className='fs-4' style={{opacity: "0.85"}}>Customer-first always</h2>
                    <p className='mb-5 text-muted'>That's why 1.5+ crore customers trust Zerodha with ₹4.5+ lakh crores worth of equity investments.</p>
                    
                    <h2 className='fs-4' style={{opacity: "0.85"}}>No spam or gimmicks</h2>
                    ...
                    <h2 className='fs-4' style={{opacity: "0.85"}}>The Zerodha universe</h2>
                    ...
                    <h2 className='fs-4' style={{opacity: "0.85"}}>Do better with money</h2>
