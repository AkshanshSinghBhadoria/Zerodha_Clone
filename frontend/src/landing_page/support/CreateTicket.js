...
function CreateTicket() {
  return (
    <div className="container">
      ...
      <div className="col-4 p-5 mt-2 mb-2">
        <h4 className="text-muted fs-5"><i class="fa-solid fa-chart-simple"></i> Trading and Markets</h4>
      ...
      <div className="col-4 p-5 mt-2 mb-2">
        <h4 className="text-muted fs-5"><i class="fa-regular fa-envelope"></i> Funds</h4>
      ...
      <div className="col-4 p-5 mt-2 mb-2">
        <h4 className="text-muted fs-5"><i class="fa-regular fa-circle-user"></i> Console</h4>
      ...
      <div className="col-4 p-5 mt-2 mb-2">
        <h4 className="text-muted fs-5"><i class="fa-solid fa-coins"></i> Coin</h4>
